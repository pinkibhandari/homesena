            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter booking code">
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" placeholder="Enter total amount" step="0.01">
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" rows="2" placeholder="Enter any notes"></textarea>
                    </div>
                </div>

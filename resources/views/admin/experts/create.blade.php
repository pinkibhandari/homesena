...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Create Expert</h5>
        ...
        <form>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter registration code">
                </div>

                <!-- Onboarding Agent Code -->
                <div class="col-lg-4 col-md-6 col-12 mb-3">
                    <label class="form-label">Onboarding Agent Code</label>
                    <input type="text" class="form-control" placeholder="Enter agent code">
                </div>
            ...
            <div class="mt-3">
                <button class="btn btn-primary">
                    <i class="ri-save-line me-1"></i> Save Expert
                </button>
            </div>

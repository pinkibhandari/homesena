...
@section('title', 'Experts Dashboard')
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <h5 class="card-title mb-0">Experts List</h5>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input type="search" class="form-control form-control-sm" placeholder="Search experts..."
                        style="width:200px;">
                </div>
            ...
            <table class="table table-hover align-middle table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="fw-semibold">REG20260316</span>
                        </td>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.experts.edit') }}">

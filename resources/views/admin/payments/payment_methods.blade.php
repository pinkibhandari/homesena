...
@section('title', 'Payment Methods Dashboard')
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input type="search" class="form-control form-control-sm" placeholder="Search payment methods..."
                        style="width:200px;">
                </div>

                <!-- Add Button -->
                <a href="{{ route('admin.payments.create_payment_methods') }}" class="btn btn-primary btn-sm">
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.payments.edit_payment_methods') }}">

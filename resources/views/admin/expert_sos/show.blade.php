...
<div class="card">
    ...
    <div class="row px-3 px-md-4 py-3 align-items-center">
        ...
        <div class="col-12 col-md-2 text-center mb-3 mb-md-0">
            <img 
                src="{{ $expert_sos->expert && $expert_sos->expert->profile_image 
        ...
        <div class="col-12 col-md-10">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-2">
                    ...
                    {{ optional($expert_sos->resolved_at)->format('d M Y, h:i A') ?? '-' }}
                </div>
    ...
    <div class="px-3 px-md-4 py-3">
        ...
        <a target="_blank"
            href="https://www.google.com/maps?q={{ $expert_sos->latitude }},{{ $expert_sos->longitude }}"
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let lat = parseFloat("{{ $expert_sos->latitude ?? 0 }}");
    let lng = parseFloat("{{ $expert_sos->longitude ?? 0 }}");
    ...
    if (!lat || !lng) {
        document.getElementById('map').innerHTML = 
            "<p class='text-danger text-center mt-3'>Location not available</p>";
        return;
    }

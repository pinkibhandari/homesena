                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="padding-top: 0; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                ...
                                <span style="display: block; font-weight: bold; font-size: 13px; color: #111;
                                    margin-bottom: 4px;">Customer Name</span>
                        ...
                        <tr>
                            <td style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                font-family: Arial, sans-serif;">
                                <span style="display: block; font-weight: bold; font-size: 13px; color: #111;
                                    margin-bottom: 4px;">Delivery Address</span>
                                <span style="display: block; font-size: 12.5px; color: #1a1a1a;
                        ...
                        <tr>
                            <td style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                font-family: Arial, sans-serif;">
                                <span style="display: block; font-weight: bold; font-size: 13px; color: #111;
                                    margin-bottom: 4px;">Invoice Date</span>
                                <span style="display: block; font-size: 12.5px; color: #1a1a1a;
                        ...
                        <tr>
                            <td style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                font-family: Arial, sans-serif;">
                                <span style="display: block; font-weight: bold; font-size: 13px; color: #111;
                                    margin-bottom: 4px;">State Name &amp; Code</span>
                                <span style="display: block; font-size: 12.5px; color: #1a1a1a;
                                    line-height: 1.55;">Haryana 06</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                font-family: Arial, sans-serif;">
                                <span style="display: block; font-weight: bold; font-size: 13px; color: #111;
                                    margin-bottom: 4px;">Place of Supply</span>
                                <span style="display: block; font-size: 12.5px; color: #1a1a1a;
                                    line-height: 1.55;">Haryana 06</span>
                            </td>
                        </tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="padding-top: 0; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                ...
                                <span style="display: block; font-weight: bold; font-size: 13.5px; color: #111;
                                    letter-spacing: 0.3px;">DELIVERY SERVICE PROVIDER</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                font-family: Arial, sans-serif;">
                                <span style="display: block; font-weight: bold; font-size: 13px; color: #111;
                                    margin-bottom: 4px;">Business Name</span>
                                <span style="display: block; font-size: 12.5px; color: #1a1a1a;
                                    line-height: 1.55;">Your Company Pvt Ltd</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cccccc;
                                ...
                                <span style="display: block; font-size: 12.5px; color: #1a1a1a;
                                    line-height: 1.55;">Company Address</span>
                            </td>
                        </tr>
            ...
            <thead>
                <tr>
                    <th style="background-color: #f2f2f2; padding: 9px 10px; font-size: 13px; font-weight: bold;
                        ...
                        font-family: Arial, sans-serif; width: 52%;">Items</th>
                    <th style="background-color: #f2f2f2; padding: 9px 10px; font-size: 13px; font-weight: bold;
                        color: #111; text-align: right; border-top: 1px solid #bbb; border-bottom: 1px solid #bbb;
                        font-family: Arial, sans-serif; width: 28%;">&nbsp;</th>
                    <th style="background-color: #f2f2f2; padding: 9px 10px; font-size: 13px; font-weight: bold;
                        color: #111; text-align: right; border-top: 1px solid #bbb; border-bottom: 1px solid #bbb;
                        font-family: Arial, sans-serif; width: 20%;">Taxable Value</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="padding: 7px 10px; text-align: right; font-size: 12.5px; color: #444;
                    font-family: Arial, sans-serif;">Discount</td>
                <td style="width: 20%; padding: 7px 10px; text-align: right; font-size: 12.5px; color: #111;
                    white-space: nowrap; font-family: Arial, sans-serif;">- Rs. 0</td>
            </tr>
            <tr>
                <td style="width: 52%; padding: 7px 10px; font-family: Arial, sans-serif;"></td>
                <td style="padding: 7px 10px; text-align: right; font-size: 12.5px; color: #444;
                    font-family: Arial, sans-serif;">Gross Amount</td>
                <td style="width: 20%; padding: 7px 10px; text-align: right; font-size: 12.5px; color: #111;
                    white-space: nowrap; font-family: Arial, sans-serif;">Rs. {{ number_format($gross, 2) }}</td>
            </tr>
            <tr>
                <td style="padding: 10px 10px; font-size: 13.5px; font-weight: bold; color: #111;
                    border-top: 1.5px solid #bbb; text-align: left;
                    font-family: Arial, sans-serif;">TOTAL AMOUNT</td>
                ...
                <td style="width: 20%; padding: 10px 10px; font-size: 13.5px; font-weight: bold; color: #111;
                    ...
                    font-family: Arial, sans-serif;">Rs. {{ number_format($gross, 0) }}</td>
            </tr>
        </table>
